...
class MontezumaDescriptor(Descriptor):
    def __init__(self):
        ...
        self.models = ['rnd', 'cnd', 'cnd']
        self.agents = [PPOAtariRNDAgent, PPOAtariSNDAgent, PPOAtariSNDAgent]
        self.config_ids = [2, 42, 44]
        self.labels = ['RND', 'SND-STD', 'SND-VIC']
...
class CaveflyerDescriptor(Descriptor):
    def __init__(self):
        ...
        self.agents = [PPOProcgenRNDAgent, PPOProcgenSNDAgent, PPOProcgenSNDAgent, PPOProcgenSNDAgent]
        self.config_ids = [2, 4, 7, 9]
        self.labels = ['RND', 'SND-STD', 'SND-VIC', 'SND-VINV']
...
class MontezumaSPDescriptor(Descriptor):
    def __init__(self):
        ...
        self.env_id = 'MontezumaRevengeNoFrameskip-v4'
        self.models = ['icm', 'fwd']
        self.agents = [PPOAtariICMAgent, PPOAtariSPAgent]
...
class CaveflyerSPDescriptor(Descriptor):
    def __init__(self):
        ...
        self.env_id = 'procgen-caveflyer-v0'
        self.models = ['icm', 'fwd']
        self.agents = [PPOProcgenICMAgent, PPOProcgenSPAgent]
        self.config_ids = [6, 5]
        self.labels = ['ICM', 'SP']
...
if __name__ == '__main__':
    ...
    descriptors = [MontezumaSPDescriptor]
    # descriptors = [ClimberDescriptor, CaveflyerDescriptor, CoinrunDescriptor, JumperDescriptor]
    # descriptors = [MontezumaSPDescriptor, GravitarSPDescriptor, PrivateEyeSPDescriptor, SolarisSPDescriptor, VentureSPDescriptor, PitfallSPDescriptor]
    # descriptors = [ClimberSPDescriptor, CaveflyerSPDescriptor, CoinrunSPDescriptor, JumperSPDescriptor]

    for desc in descriptors:
        desc_instance = desc()
        config = generate_analytic_data(desc_instance, gen_ref_states=False, gen_features=True)
