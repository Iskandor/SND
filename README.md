...
<figcaption align = "center">
<b>Fig.2 - Average cumulative external reward per episode for tested models. The best model for each environment is shown in bold face.</b>
</p>
</figcaption>
</figure>
...
#### SND-VIC
method uses VICReg algorithm [[3]](#3) algorithm for training target model $\Phi^{\rm T}$.
...
<figcaption align = "center">
<b>Fig.1 - The cumulative external reward per episode (with the standard deviation)
...
<figcaption align = "center">
<b>Fig.3 - Average maximal score reached by tested models on Atari environments. The best model for each environment is shown in bold face.</b>
</p>
</figcaption>
</figure>
